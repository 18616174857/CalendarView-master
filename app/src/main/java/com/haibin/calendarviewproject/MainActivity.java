...
//                                        mCalendarView.getCurYear(), mCalendarView.getCurMonth(), 23);
    ...
    protected void onResume() {
        ...
        for (int y = 1997; y < 2082; y++) {
            for (int m = 1; m <= 12; m++) {
                ...
                map.put(getSchemeCalendar(y, m, 14, 0xFF33aadd, "三四十").toString(),
                        getSchemeCalendar(y, m, 14, 0xFF33aadd, "三四十"));
                map.put(getSchemeCalendar(y, m, 15, 0xFF1aff1a, "三四十").toString(),
                        getSchemeCalendar(y, m, 15, 0xFF1aff1a, "ssss"));
                map.put(getSchemeCalendar(y, m, 16, 0xFF22acaf, "三四十").toString(),
                        getSchemeCalendar(y, m, 16, 0xFF22acaf, "三四十"));
                map.put(getSchemeCalendar(y, m, 17, 0xFF99a6fa, "三四十").toString(),
                        getSchemeCalendar(y, m, 17, 0xFF99a6fa, "三四十"));
                map.put(getSchemeCalendar(y, m, 18, 0xFFe69138, "三四十").toString(),
                        getSchemeCalendar(y, m, 18, 0xFFe69138, "三四十"));
                map.put(getSchemeCalendar(y, m, 26, 0xFF40db25, "ssss ").toString(),
                        getSchemeCalendar(y, m, 26, 0xFF40db25, "ssss "));
                map.put(getSchemeCalendar(y, m, 27, 0xFF95af1a, "三四十").toString(),
                        getSchemeCalendar(y, m, 27, 0xFF95af1a, "ssss "));
                map.put(getSchemeCalendar(y, m, 28, 0xFF40db25, "三四十").toString(),
                        getSchemeCalendar(y, m, 28, 0xFF40db25, " ssss"));
            }
        }
        //28560 数据量增长不会影响UI响应速度，请使用这个API替换
     //   mCalendarView.setSchemeDate(map);
    ...
    public void onCalendarOutOfRange(Calendar calendar) {
        ...
        Toast.makeText(this, "onCalendarOutOfRange\n" , Toast.LENGTH_SHORT).show();
    }
...
//        "  --  " + calendar.getLunarCalendar().getYear());
    ...
    public void onMonthChange(int year, int month) {
        ...
        Toast.makeText(this, "滑动监听\n" , Toast.LENGTH_SHORT).show();
    }

    @Override
    public void onViewChange(boolean isMonthView) {
        Log.e("onViewChange", "  ---  " + (isMonthView ? "月视图" : "周视图"));
        Toast.makeText(this, "onViewChange\n" , Toast.LENGTH_SHORT).show();
    }
